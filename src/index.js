...
export default class MarkdownFormatter extends React.Component {
    ...
    constructor(props) {
        ...
        for (var i = 0; i < props.regexArray.length; i++) {
    ...
    createJsx(elementJsxArray, elementStylesArray, elementLinksArray){
        // create jsx element 
        var partialJsx = [];                        
        var fullJsx = [];
...
MarkdownFormatter.propTypes = {
    regexArray: PropTypes.arrayOf(PropTypes.shape({
        type: PropTypes.string.isRequired,
        styles: PropTypes.array.isRequired,
        pattern: PropTypes.string.isRequired,
        patternType: PropTypes.oneOf(['asymmetric', 'symmetric', 'custom']).isRequired,
